...
//==============================================================================
DroneDelayProcessor::DroneDelayProcessor() : delayBuffer_ (2, 1)
{
    // Set default values:
    delayLength_ = 0.5;
    dryMix_ = 1.0;
...
DroneDelayProcessor::~DroneDelayProcessor()
{
}

//==============================================================================
const String DroneDelayProcessor::getName() const
{
    return String::empty;
}

int DroneDelayProcessor::getNumParameters()
{
    return kNumParameters;
}

float DroneDelayProcessor::getParameter (int index)
{
...
void DroneDelayProcessor::setParameter (int index, float newValue)
{
    // This method will be called by the host, probably on the audio thread, so
    // it's absolutely time-critical. Don't use critical sections or anything
    // UI-related, or anything at all that may block in any way!
...
const String DroneDelayProcessor::getParameterName (int index)
{
    switch (index)
    {
...
const String DroneDelayProcessor::getParameterText (int index)
{
    return String (getParameter (index), 2);
}

const String DroneDelayProcessor::getInputChannelName (int channelIndex) const
{
    return String (channelIndex + 1);
}

const String DroneDelayProcessor::getOutputChannelName (int channelIndex) const
{
    return String (channelIndex + 1);
}

bool DroneDelayProcessor::isInputChannelStereoPair (int index) const
{
    return true;
}

bool DroneDelayProcessor::isOutputChannelStereoPair (int index) const
{
    return true;
}

bool DroneDelayProcessor::silenceInProducesSilenceOut() const
{
...
double DroneDelayProcessor::getTailLengthSeconds() const
{
    return 0.0;
}
bool DroneDelayProcessor::acceptsMidi() const
{
...
bool DroneDelayProcessor::producesMidi() const
{
...
int DroneDelayProcessor::getNumPrograms()
{
    return 0;
}

int DroneDelayProcessor::getCurrentProgram()
{
    return 0;
}

void DroneDelayProcessor::setCurrentProgram (int index)
{
}

const String DroneDelayProcessor::getProgramName (int index)
{
    return String::empty;
}

void DroneDelayProcessor::changeProgramName (int index, const String& newName)
{
}

//==============================================================================
void DroneDelayProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
void DroneDelayProcessor::releaseResources()
{
...
void DroneDelayProcessor::reset()
{
...
void DroneDelayProcessor::processBlock (AudioSampleBuffer& buffer, MidiBuffer& midiMessages)
{
    // Helpful information about this block of samples:
    const int numInputChannels = buffer.getNumChannels();     // How many input channels for our effect?
    const int numOutputChannels = buffer.getNumChannels();   // How many output channels for our effect?
...
//==============================================================================
bool DroneDelayProcessor::hasEditor() const
{
    return false; // (change this to false if you choose to not supply an editor)
}

AudioProcessorEditor* DroneDelayProcessor::createEditor()
{
    return nullptr;
}

//==============================================================================
void DroneDelayProcessor::getStateInformation (MemoryBlock& destData)
{
...
void DroneDelayProcessor::setStateInformation (const void* data, int sizeInBytes)
{
