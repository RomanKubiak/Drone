    ...
    : owner(_owner)
{
    ...
    oscLevelA->setRange (0.01, 1, 0.01);
    ...
    oscLevelR->setRange (0.01, 1, 0.01);
    ...
    noiseLevelA->setRange (0, 1, 0.001);
    ...
    noiseLevelR->setRange (0, 1, 0.001);
    ...
    distortionType->setSelectedId(1, sendNotification);
    //[/UserPreSize]
...
<JUCER_COMPONENT documentType="Component" className="DSynthUI" componentName=""
  ...
  <SLIDER name="oscFreqA" id="4fd78b12fae831f9" memberName="oscFreqA" virtualName=""
          explicitFocusOrder="0" pos="0% 0% 10% 20%" min="0.010000000000000000208"
  ...
  <SLIDER name="oscLevelA" id="aed3b24e406f1a3d" memberName="oscLevelA"
          virtualName="" explicitFocusOrder="0" pos="0% 20% 10% 20%" min="0.010000000000000000208"
          max="1" int="0.010000000000000000208" style="RotaryVerticalDrag"
          textBoxPos="TextBoxBelow" textBoxEditable="1" textBoxWidth="80"
          textBoxHeight="20" skewFactor="1"/>
  <SLIDER name="oscLevelR" id="6d9827f3f0f0cef0" memberName="oscLevelR"
          virtualName="" explicitFocusOrder="0" pos="10% 20% 10% 20%" min="0.010000000000000000208"
          max="1" int="0.010000000000000000208" style="RotaryVerticalDrag"
          textBoxPos="TextBoxBelow" textBoxEditable="1" textBoxWidth="80"
          textBoxHeight="20" skewFactor="1"/>
  <SLIDER name="noiseLevel" id="c39ea9e4297a712e" memberName="noiseLevel"
          ...
          rotarysliderfill="7fff0000" textboxhighlight="40ee1111" min="0"
  ...
  <SLIDER name="noiseLevelA" id="8f6107f1eaf16bac" memberName="noiseLevelA"
          virtualName="" explicitFocusOrder="0" pos="0% 50% 10% 20%" min="0"
          max="1" int="0.0010000000000000000208" style="RotaryVerticalDrag"
          textBoxPos="TextBoxBelow" textBoxEditable="1" textBoxWidth="80"
          textBoxHeight="20" skewFactor="1"/>
  <SLIDER name="noiseLevelR" id="39693fb14607c305" memberName="noiseLevelR"
          virtualName="" explicitFocusOrder="0" pos="10% 50% 10% 20%" min="0"
          max="1" int="0.0010000000000000000208" style="RotaryVerticalDrag"
          textBoxPos="TextBoxBelow" textBoxEditable="1" textBoxWidth="80"
          textBoxHeight="20" skewFactor="1"/>
  <COMBOBOX name="oscShape" id="b8e00a546e74d021" memberName="oscShape" virtualName=""
            ...
            editable="0" layout="33" items="Sin&#10;Saw&#10;Square" textWhenNonSelected="Sin"
